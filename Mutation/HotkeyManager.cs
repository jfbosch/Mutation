...
namespace Mutation
{
    public class HotkeyManager
    {
            ...
            Action textToSpeech)
        {
            ...
            _hkScreenshotOcr.Pressed += async (s, e) => await ocrFromClipboard(OcrReadingOrder.TopToBottomColumnAware).ConfigureAwait(false);
            TryRegisterHotkey(_hkScreenshotOcr);

            _hkScreenshotLeftToRightTopToBottomOcr = MapHotKey(_settings.AzureComputerVisionSettings.ScreenshotLeftToRightTopToBottomOcrHotKey);
            _hkScreenshotLeftToRightTopToBottomOcr.Pressed += async (s, e) => await ocrFromClipboard(OcrReadingOrder.LeftToRightTopToBottom).ConfigureAwait(false);
            ...
            _hkOcrLeftToRightTopToBottom = MapHotKey(_settings.AzureComputerVisionSettings.OcrLeftToRightTopToBottomHotKey);
